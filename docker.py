...
while True:
    ...
    elif ((("check" in ch) or ("look" in ch)) or ("see" in ch))  and (("docker" in ch) or ("docker software" in ch))):
    ...
    elif ((("see" in ch) or ("check" in ch)) and (("image" in ch) or ("images" in ch) or ("docker images" in ch))):
    ...
    elif ((("see" in ch) or ("check" in ch)) and (("running os" in ch) or ("running container" in ch) or ("running docker container" in ch))):
